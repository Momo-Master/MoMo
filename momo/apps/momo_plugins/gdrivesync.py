...
class GdriveSync(plugins.Plugin):
            ...
            if not self.backup:
                ...
                if not backup_folder_file_list:
                    ...
                    with zipfile.ZipFile(zip_file_path, "w") as zip_ref:
                        for root, _dirs, files in os.walk("/home/pi/backup"):
                            for file in files:
    ...
    def backup_files(self, paths, dest_path):
        for src_path in paths:
            try:
                ...
                logging.exception(f"[gDriveSync] Error during backup_path: {e}")
    ...
    def upload_to_gdrive(self, backup_path, gdrive_folder):
        try:
            ...
            logging.exception(f"[gDriveSync] Error during upload_to_gdrive: {e}")
